...
urlpatterns = patterns('',
     ...
     url(r'^clubs/add/$', direct_to_template, {'template': 'add_club.html'}),
     url(r'^events/add/$', direct_to_template, {'template': 'add_event.html'}),
...
urlpatterns += patterns('cdi.home.views',
        ...
        (r'^colleges/region/(\d)/$', 'colleges_region'),
